...
var require_builder = __commonJS({
  "node_modules/@netlify/functions/dist/lib/builder.js"(exports) {
    ...
    var augmentResponse = function(response) {
      ...
      var metadata = { version: consts_1.METADATA_VERSION, builder_function: consts_1.BUILDER_FUNCTIONS_FLAG, ttl: (_a4 = response.ttl) !== null && _a4 !== void 0 ? _a4 : 0 };
...
var require_secrets_helper = __commonJS({
  "node_modules/@netlify/functions/dist/lib/secrets_helper.js"(exports) {
    ...
    var formatSecrets = function(result) {
      var _a4, _b, _c;
      var responseServices = (_c = (_b = (_a4 = result === null || result === void 0 ? void 0 : result.data) === null || _a4 === void 0 ? void 0 : _a4.me) === null || _b === void 0 ? void 0 : _b.serviceMetadata) === null || _c === void 0 ? void 0 : _c.loggedInServices;
      if (!responseServices) {
        return {};
      }
      var newSecrets = responseServices.reduce(function(acc, service) {
        ...
        return __assign(__assign({}, acc), (_a5 = {}, _a5[normalized] = service, _a5));
      }, {});
      return newSecrets;
    };
    var getSecrets = function(event) {
      return __awaiter(void 0, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            case 0:
              eventToken = (_a4 = event) === null || _a4 === void 0 ? void 0 : _a4.authlifyToken;
...
// netlify/functions/weather/weather.ts
__export(exports, {
  handler: () => handler
});
...
// netlify/functions/weather/weather.ts
var API_KEY = process.env.OPEN_WEATHER_API;
var handler = async (event, context) => {
  ...
  return fetch(API_ENDPOINT, { headers: { Accept: "application/json" } }).then((response) => response.json()).then((data) => ({
    statusCode: 200,
